...
error message and dies, just like we did in the last exercise.
This will find many errors.
3. Never nest if-statements more than two deep and always try to
do them one deep.
4. Treat if-statements like paragraphs, where each il-elif-else
...
their calculations to variables earlier in your function and use a good 
...
2. Use a for-loop for all other kinds of looping, especially if there
...
3. Make sure parts of your program work as you work on them. Do not write
